...
class LaserScan:
    ...
    def __init__(self, project=False, H=64, W=1024, fov_up=3.0, fov_down=-25.0, aug_prob=None, only_rgb=False):
...
class SemLaserScan(LaserScan):
    ...
    def __init__(self, sem_color_dict=None, project=False, H=64, W=1024, fov_up=3.0, fov_down=-25.0, max_classes=300, aug_prob=None, only_rgb=False):
        super(SemLaserScan, self).__init__(project, H, W, fov_up, fov_down, aug_prob=aug_prob, only_rgb=only_rgb)
        self.reset()
