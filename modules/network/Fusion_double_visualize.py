...
class Fusion(nn.Module):
    ...
    def forward(self, x, rgb):
        ...
        for i in range(20):
            ...
            a.axis("off")
        plt.savefig(str('feature_maps_lidar.jpg'), bbox_inches='tight')
        ...
        for i in range(20):
            ...
            imgplot = plt.imshow(processed[i])
            a.axis("off")
        plt.savefig(str('feature_maps_rgb.jpg'), bbox_inches='tight')
        ...
        for i in range(20):
            ...
            imgplot = plt.imshow(processed[i])
            a.axis("off")
        plt.savefig(str('feature_maps_fusion.jpg'), bbox_inches='tight')
        ...
        for i in range(20):
            ...
            imgplot = plt.imshow(processed[i])
            a.axis("off")
        plt.savefig(str('class masks.jpg'), bbox_inches='tight')
