...
class Fusion(nn.Module):
    ...
    def __init__(self, nclasses, aux=True, block=BasicBlock, layers=[3, 4, 6, 3], if_BN=True,
        ...
        """BACKBONE"""
        weights_resnet = MaskRCNN_ResNet50_FPN_V2_Weights.DEFAULT
        self.resnet_transforms = weights_resnet.transforms()
        self.resnet = maskrcnn_resnet50_fpn_v2(weights=weights_resnet, trainable_backbone_layers=0).backbone
    ...
    def forward(self, x, rgb):
        ...
        x_rgb_features = F.interpolate(
                x_rgb_features, size=proj_size, mode='bilinear', align_corners=True)
        ...
        x_rgb_features = self.conv_before_fusion_rgb(x_rgb_features)
...
if __name__ == "__main__":
    ...
    overfit_test(model, 1, lidar_sze=(5, 64, 192), rgb_sze=(3, 376, 1241))
